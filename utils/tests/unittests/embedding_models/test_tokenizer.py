...
from embedding_models import tokenizer
from embedding_models.tokenizer import ENCODING_MODEL_NAME
...
class TextTokenizerTestCase(unittest.TestCase):
    ...
    def test_tokenizing(self):
        ...
        result = tokenizer.tokenize_text(
            text, ENCODING_MODEL_NAME.TEXT_EMBEDDING_3_SMALL
        )
        ...
        result = tokenizer.tokenize_text(
            text, ENCODING_MODEL_NAME.TEXT_EMBEDDING_ADA_002
        )
        self.assertEqual(result, [2028, 374, 264, 1296])
