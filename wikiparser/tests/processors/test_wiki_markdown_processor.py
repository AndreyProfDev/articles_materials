...
from processors import wiki_markdown_processor
...
class MarkdownProcessorTestCase(unittest.TestCase):
    ...
    def test_removal_of_multiple_nested_references_with_file_reference_on_top_from_text(
        self,
    ):
        text = wiki_markdown_processor.process_wiki_markdown(
    ...
    def test_removal_of_file_link(self):
        text = wiki_markdown_processor.process_wiki_markdown(
            "[[File:Przyszloscludzkosci.png|thumb|język = en}}]] test"
        )
    ...
    def test_removal_of_blockquote(self):
        text = wiki_markdown_processor.process_wiki_markdown(
            "Test <blockquote>text</blockquote> text"
        )
        self.assertEqual(text, "Test \ntext\n text")
